...
WebRtcStreamer.prototype.connect = function(videourl, audiourl, options, localstream) {
	...
	if (!this.iceServers) {
		...
		fetch(this.srvurl + "/api/getIceServers",{mode:"cors"})
...
WebRtcStreamer.prototype.onReceiveGetIceServers = function(iceServers, videourl, audiourl, options, stream) {
	...
	try {
		...
		var callurl = this.srvurl + "/api/call?peerid=" + this.pc.peerid + "&url=" + encodeURIComponent(videourl) + "&options=rtptransport%3Dtcp%26timeout%3D10";
		if (audiourl) {
